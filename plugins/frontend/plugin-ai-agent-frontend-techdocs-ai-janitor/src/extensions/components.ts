...
/** New frontend page extension for read-only TechDocs audits. */
export const techdocsJanitorPageExtension = PageBlueprint.make({
  name: 'techdocs-ai-janitor',
  params: {
    path: ROOT_PATH,
    ...
    loader: () =>
      ...
      import('../components/TechdocsJanitorPage/TechdocsJanitorPage').then(
        module => React.createElement(module.TechdocsJanitorPage),
      ),
  },
});
