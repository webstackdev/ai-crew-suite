...
import { kubernetesAiResponderApiExtension } from './extensions/api';
import { incidentTriagePageExtension } from './extensions/components';

const extension = (value: unknown): ExtensionDefinition =>
  value as ExtensionDefinition;

const extensions = [
  extension(kubernetesAiResponderApiExtension),
  extension(incidentTriagePageExtension),
];
