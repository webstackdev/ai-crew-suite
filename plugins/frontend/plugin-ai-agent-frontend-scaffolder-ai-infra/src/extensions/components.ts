...
/** New-frontend-system page extension for approved-blueprint previews. */
export const scaffolderInfraPageExtension = PageBlueprint.make({
  name: 'scaffolder-ai-infra',
  params: {
    path: ROOT_PATH,
    ...
    loader: () =>
      ...
      import('../components/InfraPreviewPage/InfraPreviewPage').then(
        module => React.createElement(module.InfraPreviewPage)
      )
  }
});
