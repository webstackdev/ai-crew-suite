...
import complianceModule, { aiCoreBackendModuleCompliance } from '../module';

const getRegistrations = () =>
  (aiCoreBackendModuleCompliance as unknown as {
...
describe('aiCoreBackendModuleCompliance', () => {
  it('exports an installable backend module for the ai-core plugin', () => {
    expect(complianceModule).toBe(aiCoreBackendModuleCompliance);
