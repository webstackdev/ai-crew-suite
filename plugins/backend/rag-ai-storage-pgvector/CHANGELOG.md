# @webstackbuilders/rag-ai-storage-pgvector
...
- 43962bd: Remove `@webstackbuilders/backend-common`. The interface of `createRoadiePgVectorStore` now expects `DatabaseService` in place of `PluginDatabaseManager`.
