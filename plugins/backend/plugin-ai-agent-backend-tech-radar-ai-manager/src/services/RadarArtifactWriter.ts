...
export const radarAnalysisArtifact = (runId: string, analysis: RadarAnalysis): AgentEvent => ({ type: 'artifact', data: { runId, kind: RADAR_ANALYSIS_ARTIFACT, ref: JSON.stringify(analysis) } });
