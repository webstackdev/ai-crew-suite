...
- Embeddings module
  ...
  - Currently, you can find embeddings modules for [AWS Bedrock](/plugins/backend/plugin-ai-core-backend-embeddings-aws/README.md) and [OpenAI](/plugins/backend/plugin-ai-core-backend-embeddings-openai/README.md).
...
See more information from the [module package](/plugins/backend/plugin-ai-core-backend-retrieval-augmenter/README.md).
...
See more information from the [module package](/plugins/backend/plugin-ai-core-backend-embeddings-aws/README.md).
...
See more information from the [module package](/plugins/backend/plugin-ai-core-backend-embeddings-openai/README.md).
...
The `@webstackbuilders/plugin-ai-core-backend` exposes a router function that can be registered directly into a standard Backstage application.
