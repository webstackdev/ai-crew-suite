...
import obsModule, { aiCoreBackendModuleObservability } from '../module';

const getRegistrations = () =>
  (aiCoreBackendModuleObservability as unknown as {
...
describe('aiCoreBackendModuleObservability', () => {
  it('exports an installable backend module for the ai-core plugin', () => {
    expect(obsModule).toBe(aiCoreBackendModuleObservability);
