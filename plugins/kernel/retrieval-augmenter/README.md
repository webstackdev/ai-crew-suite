# @ai-crew-suite/plugin-kernel-backend-module-retrieval-augmenter
...
yarn workspace @ai-crew-suite/plugin-kernel-backend-module-retrieval-augmenter build
```
...
```bash
yarn workspace @ai-crew-suite/plugin-kernel-backend-module-retrieval-augmenter test
```
