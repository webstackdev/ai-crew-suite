...
/**
 * New-frontend-system API blueprint installing the `RfcAdrReviewerClient`
 * against the config, discovery, fetch, and identity APIs.
 */
export const rfcAdrReviewerApiExtension = ApiBlueprint.make({
  params: defineParams =>
    defineParams(
      createApiFactory({
